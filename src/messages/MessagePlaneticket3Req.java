...
import java.util.Vector;
	...
	public class MessagePlaneticket3Req extends Message implements Serializable {
		...
		public MessagePlaneticket3Req(String flightsNumber  , String board  ,String start  , String end,String day   , String departureTime   ,
				String arriverTime   , String ticketPrice ,String seat   , String grade   ,String surplusSeat   , String surplusGrade ) {
			super(MSG_TYPE.MSG_planeticket3_REQ);
