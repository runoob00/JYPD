...
public class MessageOrderfrom3Ack extends Message implements Serializable{
	/**
	 * 
	 */
	...
	public MessageOrderfrom3Ack(String flightsNumber,String day,String name) {
		super(MSG_TYPE.MSG_Orderfrom3_ACK);
